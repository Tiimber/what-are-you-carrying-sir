...
public class ConcaveColliderEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        PropCreateMeshAssets.boolValue      = EditorGUILayout.Toggle(new GUIContent("Create Mesh Assets", "Will generate mesh assets for all hulls. This enables prefab instancing at both editing and runtime"), PropCreateMeshAssets.boolValue);  
        PropCreateHullMesh.boolValue        = EditorGUILayout.Toggle(new GUIContent("Create Hull Mesh", "Besides the collider components, also adds a MeshFilter to each hull that can be used for other things"), PropCreateHullMesh.boolValue);
