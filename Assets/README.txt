...
AdvancedRagdoll is a C# script that synchs standard Unity 3 ragdolls with animated meshes, 
allowing seamless transitions, both when creating a ragdoll from an animated mesh, and when
blending from a ragdoll back to an animated mesh.
