...
public class MeshCombineWizard2 : ScriptableWizard
{
	public GameObject combineParent;
	public bool is32bit = true;

	[MenuItem("E.S. Tools/Mesh Combine Wizard 2")]
	static void CreateWizard()
	{
		var wizard = DisplayWizard<MeshCombineWizard2>("Mesh Combine Wizard 2");
